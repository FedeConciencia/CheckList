...
public class ControladorSeco {
    ...
    public void insertarSeco(Seco seco) {
        ...
        try {
            ...
            ps.setString(3, seco.getmLineales());
            ps.setString(4, seco.getmPerson());
            ps.setString(5, seco.getM2Muro());
            ps.setString(6, seco.getMuroPerson());
            ps.setString(7, seco.getM2Cubierta());
            ps.setString(8, seco.getCubiertaPerson());
            ps.setString(9, seco.getMetrosLineales());
            ps.setString(10, seco.getLinealesPerson());
            ps.setString(11, seco.getDiasCaidos());
    ...
    public Seco buscarOneSeco(Long id) {
        ...
        try {
            ...
            if (rs.next()) {  //si nos devuelve un dato true
                ...
                String mLineales = rs.getString(4);
                String mPerson = rs.getString(5);
                String m2Muro = rs.getString(6);
                String muroPerson = rs.getString(7);
                String m2Cubierta = rs.getString(8);
                String cubiertaPerson = rs.getString(9);
                String metrosLineales = rs.getString(10);
                String linealesPerson = rs.getString(11);
                String diasCaidos = rs.getString(12);
