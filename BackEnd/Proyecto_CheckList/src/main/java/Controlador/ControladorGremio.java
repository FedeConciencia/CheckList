    ...
    public Gremio buscarOneGremio(Long id) {
        ...
        try {
            ...
            if (rs.next()) {  //si nos devuelve un dato true
                ...
                gremio = new Gremio(nombreGremio, nroPersonas, horarioDesde, horarioHasta, fechaDesde, fechaHasta, nroArgentinos, nombreContratista, apellidoContratista, fechaAlta, fechaBaja, estado, idPersona);
