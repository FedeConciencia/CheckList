        ...
        try {
            ...
            if(request.getParameter("action") != null){
                ...
                if(request.getParameter("action").equals("listar")){
                    ...
                    String m2Piso = request.getParameter("m2Piso");
                    String pisoPerson = request.getParameter("pisoPerson");
                    String metros = request.getParameter("metros");
                    String metrosPerson = request.getParameter("metrosPerson");
                    String m2Muro = request.getParameter("m2Muro");
                    String muroPerson = request.getParameter("muroPerson");
                    String m2Cubierta = request.getParameter("m2Cubierta");
                    String cubiertaPerson = request.getParameter("cubiertaPerson");
                    String metrosLineales = request.getParameter("metrosLineales");
